...
# Hyperparameters
config = {
    'n_modes_ss': 33,   # Input: First 33 sensor modes (Observable limit)
    'n_modes_ff': 10,   # Output: First 10 field modes (~10% vel error)
    'seq_len': 100,     # 100 snapshot window (centered)
    'hidden_dim': 512,  # Large enough to track modulation frequencies
    'num_layers': 2,
    'batch_size': 512,
    'lr': 1e-3
}
