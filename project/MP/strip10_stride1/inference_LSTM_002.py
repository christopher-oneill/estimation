...
master_pod_path = os.path.join(base_dir,"strip10_stride1", "mp_pod_master.h5")

model_dir = os.path.join(base_dir, "strip10_stride1",f"Model_BiLSTM_{MODEL_NUM}")
...
with h5py.File(master_pod_path, 'r') as f:
    ...
    a_ss_tr, a_ss_ts = f['train/a_ss'][:, :N_SS], f['test/a_ss'][:, :N_SS]
