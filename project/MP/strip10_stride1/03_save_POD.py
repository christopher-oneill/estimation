...
output_dir = os.path.join(base_dir, "output/kevin_2cylinder/MP/strip10_stride1")
unified_h5 = os.path.join(base_dir,"output/kevin_2cylinder/MP" ,"MP_velocity_unified.h5")
save_path = os.path.join(output_dir, "mp_pod_master.h5")
...
N_MODES = 2*len(sensor_idx) # number of modes can't exceed number of points in the sensor strip (u and v combined)
