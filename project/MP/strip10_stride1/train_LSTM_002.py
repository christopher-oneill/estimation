...
master_pod_path = os.path.join(base_dir,"strip10_stride1", "mp_pod_master.h5") # Your pre-computed file
model_dir = os.path.join(base_dir,"strip10_stride1", f"Model_BiLSTM_{MODEL_NUMBER}")
