...
def train():
    ...
    config = {
        'input_dim': 40, 
        'output_dim': 20, 
        'd_model': 256,        # Increased for higher mode resolution
        'nhead': 8,            # More heads to track different vortex structures
        'num_layers': 12,       # Deeper for chaotic flip-flop transitions
        'dim_feedforward': 256, 
