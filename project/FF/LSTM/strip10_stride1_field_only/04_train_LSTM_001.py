...
base_dir = "/media/chris-remote/Projects/ONeill/estimation/output/kevin_2cylinder/FF/LSTM/strip10_stride1_field_only"
...
config = {
    'n_modes_ss': 363*2,   # Sensor input (Far-wake x=10 needs higher mode count)
